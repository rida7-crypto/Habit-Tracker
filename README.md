...
- **Leaderboard**: Rank users based on consistency and achievements.
- **Notifications**: Reminders to stay on track with habits.
- **Gamification**: Points and ranking system to motivate users.
...
- `LeaderboardManager.java` / `LeaderboardWindow.java` → Ranking system  
- `ConsistencyWindow.java` → Track streaks and progress  
- `NotificationService.java` → Reminder system  
- `DatabaseConnection.java` → SQL connectivity  
